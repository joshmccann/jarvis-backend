...
JARVIS_SYSTEM = (
    ...
    "Answer from the CONTEXT JSON provided. It includes a 'brief' field: a running narrative, written by a "
    "Claude agent on Josh's Mac that reads his working chats, memory and handoff notes, of exactly where every "
